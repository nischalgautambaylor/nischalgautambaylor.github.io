        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with quantum computing and have been
              exploring its depths ever since.
              <br />
              <br />I am fluent in programming languages like
              <i>
                <b className="purple"> Python and MATLAB </b>
              </i>
          ...
          <Col md={4} className="myAvtar">
            <Tilt>
              <img src={myImg} className="img-fluid" alt="avatar2" />
            </Tilt>
          </Col>
        </Row>
        <Row>
